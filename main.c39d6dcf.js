...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"ts/toggleMode.ts":[function(require,module,exports) {
"use strict";
...
/** @class */
function () {
  function ToggleMode(sunIcon, moonIcon) {
    var _this = this;
    ...
    this.toggleMode = function () {
      if (!document.documentElement.hasAttribute("data-theme")) {
        ...
        _this.image.setAttribute("src", _this.sunIcon);
      } else {
        document.documentElement.removeAttribute("data-theme");

        _this.image.setAttribute("src", _this.moonIcon);
      }
    };

    this.button = document.querySelector(".header__button");
    this.image = this.button.querySelector(".header__icon");
    this.sunIcon = sunIcon;
    this.moonIcon = moonIcon;
    this.config();
  }

  ToggleMode.prototype.config = function () {
...
function () {
  ...
  TodosState.prototype.runListeners = function () {
  ...
  TodosState.prototype.syncLocalStorage = function () {
    localStorage.setItem("todos", JSON.stringify(this.todos));
  };

  TodosState.getInstance = function () {
  ...
  TodosState.prototype.getTodos = function () {
    return __spreadArray([], this.todos, true);
  };

  TodosState.prototype.subscibeListener = function (listener) {
    this.listeners.push(listener);
  };

  TodosState.prototype.addTodo = function (todo) {
    this.todos.push(todo);
    this.syncLocalStorage();
    this.runListeners();
  };

  TodosState.prototype.updateCompleted = function (id) {
  ...
  TodosState.prototype.removeTodo = function (id) {
  ...
  TodosState.prototype.clearCompleted = function () {
    this.todos = this.todos.filter(function (todo) {
  ...
  TodosState.prototype.changePosition = function (oldIdx, newIdx) {
    var dragged = this.todos.splice(oldIdx, 1)[0];
...
var state = TodosState.getInstance();
exports.default = state;
},{}],"ts/todoForm.ts":[function(require,module,exports) {
"use strict";
...
var todoState_1 = __importDefault(require("./todoState"));
...
function () {
  function TodoForm() {
    ...
    this.addTodoHandler = function (e) {
      e.preventDefault();

      var text = _this.input.value.trim();

      if (!text) return;
      todoState_1.default.addTodo({
        id: (0, uuid_1.v4)(),
        text: text,
        completed: false
      });
  ...
  TodoForm.prototype.config = function () {
...
},{"uuid":"../node_modules/uuid/dist/esm-browser/index.js","./todoState":"ts/todoState.ts"}],"ts/todoItem.ts":[function(require,module,exports) {
"use strict";
...
/** @class */
function () {
  function TodoItem(hostId, todo) {
    var _this = this;

    this.toggleCompleted = function () {
      todoState_1.default.updateCompleted(_this.todo.id);
    };

    this.removeTodo = function () {
      todoState_1.default.removeTodo(_this.todo.id);
    };

    this.hostEl = document.getElementById(hostId);
    this.template = document.getElementById("todo-item");
    var node = document.importNode(this.template, true);
    this.element = node.content.firstElementChild;
    this.completedButton = this.element.querySelector(".todo-list__btn-check");
  ...
  TodoItem.prototype.configure = function () {
...
},{"./todoState":"ts/todoState.ts"}],"../node_modules/sortablejs/modular/sortable.esm.js":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{}],"ts/todoList.ts":[function(require,module,exports) {
"use strict";
...
function () {
  function TodoList() {
    ...
    this.renderTodosListener = function (todos) {
      _this.todos = todos;

      _this.renderTodos();
    };

    this.handleFilterTodos = function (e) {
      var target = e.target;
      _this.filter = target.dataset.filter;

      _this.filterButtons.forEach(function (button) {
        if (button.dataset.filter === _this.filter) button.classList.add("active");else button.classList.remove("active");
      });
    ...
    this.clearCompleted = function (e) {
      todoState_1.default.clearCompleted();
    };

    this.list = document.getElementById("todo-list");
    this.amount = document.getElementById("amount");
    this.filterButtons = document.querySelectorAll(".btn-select");
    this.clearCompletedBtn = document.getElementById("clear-completed");
    this.filter = "all";
    this.todos = todoState_1.default.getTodos();
    this.config();
    this.renderTodos();
    new sortablejs_1.default(this.list, {
      onEnd: function onEnd(e) {
        todoState_1.default.changePosition(e.oldIndex, e.newIndex);
      },
      animation: 250
    });
  }

  TodoList.prototype.config = function () {
    var _this = this;

    todoState_1.default.subscibeListener(this.renderTodosListener);
    this.updateCount();
    this.filterButtons.forEach(function (button) {
      return button.addEventListener("click", _this.handleFilterTodos);
    });
  ...
  TodoList.prototype.renderTodos = function () {
    ...
    todos.forEach(function (todo) {
      new todoItem_1.default("todo-list", todo);
    });
  };

  TodoList.prototype.updateCount = function () {
    this.amount.textContent = this.todos.length + " item" + (this.todos.length === 1 ? "" : "s");
  };
...
},{"./todoState":"ts/todoState.ts","./todoItem":"ts/todoItem.ts","sortablejs":"../node_modules/sortablejs/modular/sortable.esm.js"}],"images/icon-sun.svg":[function(require,module,exports) {
...
var toggleMode_1 = __importDefault(require("./ts/toggleMode"));

var todoForm_1 = __importDefault(require("./ts/todoForm"));

var todoList_1 = __importDefault(require("./ts/todoList"));

var icon_sun_svg_1 = __importDefault(require("./images/icon-sun.svg"));

var icon_moon_svg_1 = __importDefault(require("./images/icon-moon.svg"));

new toggleMode_1.default(icon_sun_svg_1.default, icon_moon_svg_1.default);
new todoForm_1.default();
new todoList_1.default();
},{"./ts/toggleMode":"ts/toggleMode.ts","./ts/todoForm":"ts/todoForm.ts","./ts/todoList":"ts/todoList.ts","./images/icon-sun.svg":"images/icon-sun.svg","./images/icon-moon.svg":"images/icon-moon.svg"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
